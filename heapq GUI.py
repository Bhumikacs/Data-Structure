...
class PriorityQueueGUI:
    ...
    def create_widgets(self):
        ...
        self.enqueue_button.grid(row=3, column=0, columnspan=2, padx=10, pady=5)

        # Dequeue Button
        self.dequeue_button = tk.Button(self.root, text="Dequeue", font=('Arial', 20), command=self.dequeue)
        self.dequeue_button.grid(row=4, column=0, columnspan=2, padx=10, pady=5)

        # Peek Button
        self.peek_button = tk.Button(self.root, text="Peek", font=('Arial', 20), command=self.peek)
        self.peek_button.grid(row=5, column=0, columnspan=2, padx=10, pady=5)
        ...
        self.output_text.grid(row=0, column=2, rowspan=7, padx=10, pady=10, sticky='nsew')
